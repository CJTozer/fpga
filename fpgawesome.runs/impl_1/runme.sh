...
HD_PWD='/home/centos/fpgawesome/fpgawesome.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_testbench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_testbench.tcl -notrace
