...
package mac_types is
  ...
  type tup2_1 is record
    tup2_1_sel0 : unsigned(1 downto 0);
    tup2_1_sel1 : mac_types.tup2;
  end record;
  type array_of_signed_9 is array (integer range <>) of signed(8 downto 0);
  type tup2_3 is record
    tup2_3_sel0 : unsigned(1 downto 0);
    tup2_3_sel1 : mac_types.tup2_2;
  end record;
  ...
  function toSLV (p : mac_types.tup2_3) return std_logic_vector;
...
package body mac_types is
  ...
  function toSLV (p : mac_types.tup2_3) return std_logic_vector is
  begin
